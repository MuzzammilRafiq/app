...
export const FileSVG = (
  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    <path d="M21 11L15 5V9.4C15 9.96005 15 10.2401 15.109 10.454C15.2049 10.6422 15.3578 10.7951 15.546 10.891C15.7599 11 16.0399 11 16.6 11H21Z" fill="white" opacity="0.3"/>
  </svg>
);
