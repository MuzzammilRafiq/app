...
const ChatInput = forwardRef<ChatInputHandle, ChatInputProps>(function ChatInput(
  ...
  return (
    <div className="bg-white p-4" onDragOver={handleDragOver} onDrop={handleDrop}>
      ...
      <div className="flex items-end gap-3 bg-gray-100 rounded-full px-4 py-3 relative">
        ...
        <button
          ...
          className="p-2 bg-gray-800 text-white rounded-full hover:bg-gray-900 focus:outline-none disabled:bg-gray-300 disabled:cursor-not-allowed flex items-center justify-center transition-all duration-200 disabled:text-gray-500"
        >
          {isLoading ? (
      ...
      {showTools && <div className="fixed inset-0 z-0" onClick={() => setShowTools(false)} />}
    </div>
  );
});
